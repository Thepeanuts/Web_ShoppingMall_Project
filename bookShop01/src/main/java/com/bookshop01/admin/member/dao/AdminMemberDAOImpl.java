...
//	}
	...
	public List<MemberVO> listMember(Map condMap) throws DataAccessException{
		List<MemberVO>  memberList=sqlSession.selectList("mapper.admin.member.listMember",condMap);
		return memberList;
	}
